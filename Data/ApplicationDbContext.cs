...
namespace EmployeesManagement.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Fix foreign key delete behaviors
            ...
            // ⚙️ Fix lỗi nvarchar(max) -> longtext cho bảng Identity
            ...
            {
                entity.Property(uc => uc.ClaimType).HasColumnType("longtext");
                entity.Property(uc => uc.ClaimValue).HasColumnType("longtext");
            });

            modelBuilder.Entity<IdentityRoleClaim<string>>(entity =>
            {
                entity.Property(rc => rc.ClaimType).HasColumnType("longtext");
                entity.Property(rc => rc.ClaimValue).HasColumnType("longtext");
            });
        }
